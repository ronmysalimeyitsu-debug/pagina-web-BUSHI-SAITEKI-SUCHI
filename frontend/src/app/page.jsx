...
export default function Home() {
  ...
  return (
    <>
      {/* Importación de fuente tradicional japonesa Noto Serif JP */}
      ...
      <main style={{ 
        ...
        <header style={{ 
          ...
          {/* Botones de Contacto y Redes con Degradados Mejorados */}
        ...
        {/* Sección "Sobre Nosotros" (Filosofía Culinaria) */}
        <section style={{ 
          maxWidth: '1200px', 
