...
export default function Hero() {
  return (
    <section>
      <div className="relative rounded-lg overflow-hidden bg-black text-white" style={{ backgroundImage: 'url(/images/truck-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
